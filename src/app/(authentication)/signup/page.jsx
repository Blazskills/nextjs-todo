...
export default function Signup() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (
      !emptyStringValidator(signupValues?.username) ||
    ...
    if (!passwordLengthValidator(signupValues?.password)) {
      setShowSnackBar({
        isOpen: true,
        isError: true,
    ...
    try {
      ...
      const res = await axios.post("/api/signup", {
        ...
        password: hashSync(signupValues?.password, salt),
        ...
        <div className="col-span-2 bg-[#ffffff] custom640:min-h-[100vh] drop-shadow-2xl">
          ...
          <form className="px-[35px]">
            ...
            <button
              ...
              className="text-white bg-blue-700 hover:bg-blue-800 w-full focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-md text-[1.2em] py-[25px] dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Sign Up
            </button>
          </form>

          <div className="flex item-center justify-between px-[60px] mt-[25px]">
            <p className="text-[blue] hover:underline text-center">
